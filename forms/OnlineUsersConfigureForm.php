...
class OnlineUsersConfigureForm extends CFormModel {
    ...
    public function rules() {
        return array(
            ...
            array('adminBorderColor', 'required', 'message'=>Yii::t('onlineusers.views_config', 'Please fill out all required fields.')),
            array('adminBorderColor', 'match', 'pattern'=>'/^#[0-9a-f]{3,6}$/i', 'message'=>Yii::t('onlineusers.views_config', 'Please only enter hex color codes.')),
    ...
    public function attributeLabels() {
        return array(
            ...
            'sortOrder' => Yii::t('onlineusers.views_config', 'Widget Sort Order <i>(ex: 300)</i>'),
            'adminBorderColor' => Yii::t('onlineusers.views_config', 'Admin Border Color (Hex Code)'),
            'borderColor' => Yii::t('onlineusers.views_config', 'User Border Color')
        );
    }
